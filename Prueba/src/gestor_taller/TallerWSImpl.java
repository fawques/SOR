...
public class TallerWSImpl implements TallerWS {
    ...
    public java.lang.String getPedidos(java.lang.String id) { 
        ...
        System.out.println(id);
        try {
            java.lang.String _return = "_return-1703927750";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String hello() { 
        ...
        try {
            java.lang.String _return = "_return1937938902";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String checkActivacion(java.lang.String mail) { 
        ...
        try {
            java.lang.String _return = "_return-1282168258";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getOfertas(java.lang.String listaPedidos) { 
        ...
        try {
            java.lang.String _return = "_return-331382505";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String nuevoPedido(java.lang.String pedido) throws JMSException_Exception    { 
        ...
        try {
            java.lang.String _return = "_return1013151371";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
