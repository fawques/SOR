...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "file:/C:/Users/Silvia/workspace/SOR/Gestor/WebContent/wsdl/tallerws.wsdl",
...
public class TallerWSImpl implements TallerWS {
    ...
    /* (non-Javadoc)
     * @see gestor_taller.TallerWS#getPedidos(*
     */
    public java.lang.String getPedidos() { 
        LOG.info("Executing operation getPedidos");
        try {
            java.lang.String _return = "_return-713206468";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String hello() { 
        ...
        try {
            java.lang.String _return = "_return-610617429";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String checkActivacion(java.lang.String mail) { 
        ...
        try {
            java.lang.String _return = "_return-1834517139";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getOfertas(java.lang.String listaPedidos) { 
        ...
        try {
            java.lang.String _return = "_return885291850";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String nuevoPedido(java.lang.String pedido) throws JMSException_Exception    { 
        ...
        try {
            java.lang.String _return = "_return-16302608";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
