...
public class TallerWS_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Silvia/workspace/SOR/Gestor/WebContent/wsdl/tallerws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TallerWS_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Silvia/workspace/SOR/Gestor/WebContent/wsdl/tallerws.wsdl");
        }
        WSDL_LOCATION = url;
    }
