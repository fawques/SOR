...
public interface DesguaceJavaWS {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "hello", targetNamespace = "http://gestor_desguace_java/", className = "gestor_desguace_java.Hello")
    @WebMethod
    @ResponseWrapper(localName = "helloResponse", targetNamespace = "http://gestor_desguace_java/", className = "gestor_desguace_java.HelloResponse")
