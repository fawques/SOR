...
public class DesguaceJavaWSImpl implements DesguaceJavaWS {
    ...
    public java.lang.String checkActivacion(java.lang.String email,java.lang.String contrasenya) { 
        ...
        try {
            java.lang.String _return = "_return-1875576904";
            return _return;
    ...
    public java.lang.String generarClaveReto(java.lang.String idDesguace,java.lang.String password) { 
        ...
        try {
            java.lang.String _return = "_return2038643591";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getPedidoporID(java.lang.String string,java.lang.String idDesguace,java.lang.String password) { 
        ...
        System.out.println(password);
        try {
            java.lang.String _return = "_return1971903968";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    /* (non-Javadoc)
     * @see gestor_desguace_java.DesguaceJavaWS#hello(*
     */
    public java.lang.String hello() { 
        LOG.info("Executing operation hello");
        try {
            java.lang.String _return = "_return-837991228";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getOfertas(java.lang.String string,java.lang.String password) { 
        ...
        System.out.println(password);
        try {
            java.lang.String _return = "_return2075287508";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String nuevaOferta(java.lang.String oferta,java.lang.String idDesguace,java.lang.String password) { 
        ...
        System.out.println(password);
        try {
            java.lang.String _return = "_return1375726297";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
