...
public class AdminWS_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Gestor/services/AdminWSPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AdminWS_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Gestor/services/AdminWSPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
