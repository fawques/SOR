    ...
    public ArrayList<Pedido> getPedidosActivos(){ //devuelve pedidos en general
        ...
        try{
            ...
            while(resultados.next()){
                ...
                Pedido nuevo = new Pedido(pedidoID, resultados.getString("taller"), resultados.getNString("fecha_alta"), resultados.getNString("fecha_baja"), resultados.getNString("fecha_limite"), EstadoPedido.values()[resultados.getInt("estado")], piezas, cantidades, getOfertasPedido(pedidoID));
                lista.add(nuevo);
                //System.out.println("id: " + resultados.getString("id") + " taller: "+resultados.getInt("taller"));
            }
        }catch(SQLException ex){
    ...
    public Pedido getPedido(String id)
    {
        ...
        try{
            ...
            while(resultados.next()){
                ...
                pedido = new Pedido(resultados.getString("id"), resultados.getString("taller"), resultados.getNString("fecha_alta"), resultados.getNString("fecha_baja"), resultados.getNString("fecha_limite"), EstadoPedido.values()[resultados.getInt("estado")], piezas, cantidades, getOfertasPedido(id));
            }
        }catch(SQLException ex){
            ex.printStackTrace();
            return null;
        ...
        if (pedidos.first()) {
            while (!pedidos.isAfterLast()) {
                ...
                Pedido p = new Pedido(pedidos.getNString("id"),
                        pedidos.getInt("id_aux"), pedidos.getNString("taller"), pedidos.getNString("fecha_alta"), pedidos.getNString("fecha_baja"), pedidos.getNString("fecha_limite"), EstadoPedido.values()[pedidos.getInt("estado")],
