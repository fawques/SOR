...
public class InterfazBD{
    ...
    public void anadirPedido(int id, Date fechaAlta, int estado, int taller, Date fechaBaja, Date fechaLimite) throws JMSException
    {
        conexion.ejecutarInsert("insert INTO pedido (id, fechaAlta, estado, taller, fechaBaja, fechaLimite) values ('"+id+"','"+fechaAlta+"','"+estado+"','"+taller+"','"+fechaBaja+"','"+fechaLimite+"';");
